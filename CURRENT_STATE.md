...
type: front-door
updated: 2026-07-06T14-20-11Z
---

# CURRENT_STATE — atlas

**Last updated**: 2026-07-06T14:20Z — reflection pass (idle window). **NO ATTENDED SESSIONS** (~204h since last attended, 2026-06-28T04:08Z). Loop state unchanged: `hypothesis_space_exhausted`, `evidence=253` frozen, `signals_found=22`, `skipped_not_promotable=5`, `consecutive_empty_count=550` (from `.atlas/escalation_state.json`). **PREDICTION BUCKETS**: registration at bucket 2949 (window 2026-07-16); bucket 2948 (window 2026-07-09) is CLOSED TO NEW REGISTRATIONS; 20 predictions registered, scoring only. `open_total=40`. **CRITICAL: Phase 2b must ship before 2026-07-09T00:00Z (~57.7h = ~4.8 reflection windows)**. **LAG TAG GAP**: all 40 existing predictions lack `lag_N` tags — **18th carry-forward**. `skipped_unreplayable: 2` every cycle, `REPLAYABLE_METHODS` filter silent — **7th carry-forward**. **STALE URGENTS pending delete (18th carry-forward)**: `runtime/.handoff/URGENT-atlas-frozen-loop-2026-06-11T20-26Z.md` and `URGENT-atlas-unpushed-commits-3rd-cycle.md`. **UNREAD TICK HANDOFF**: `runtime/.handoff/general-atlas-tick-complete-2026-06-28T04-51-01Z.md` now **~202h unread** (10th consecutive window); escalation routing fix (f24d298) still not deployed; runner restart required. **BRANCH 16 AHEAD of origin** (16 reflect auto-commits; push needed). S3-P2 gate silenced (`emitted_for_current_streak: true`). **18th consecutive idle window.** 11 cycles confirmed this window via telemetry count. Predictions in bucket 2949; 2948 window is the scoring target.
